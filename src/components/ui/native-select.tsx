...
function NativeSelect({
  ...
  return (
    ...
    >
      ...
      />
      <ChevronDownIcon
        className="pointer-events-none absolute top-1/2 right-2.5 size-4 -translate-y-1/2 text-muted-foreground transition-transform duration-200 ease-out select-none group-has-[select:open]/native-select:rotate-180"
        aria-hidden="true"
