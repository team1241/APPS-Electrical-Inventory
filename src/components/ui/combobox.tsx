...
function ComboboxTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronDownIcon className="pointer-events-none size-4 text-muted-foreground transition-transform duration-200 ease-out group-data-popup-open/combobox-trigger:rotate-180 group-data-open/combobox-trigger:rotate-180 group-aria-expanded/combobox-trigger:rotate-180" />
    </ComboboxPrimitive.Trigger>
  )
}
